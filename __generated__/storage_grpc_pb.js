...
function serialize_storage_GetEpochChangeLedgerInfosRequest(arg) {
  if (!(arg instanceof storage_pb.GetEpochChangeLedgerInfosRequest)) {
    throw new Error('Expected argument of type storage.GetEpochChangeLedgerInfosRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_storage_GetEpochChangeLedgerInfosRequest(buffer_arg) {
  return storage_pb.GetEpochChangeLedgerInfosRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_storage_GetEpochChangeLedgerInfosResponse(arg) {
  if (!(arg instanceof storage_pb.GetEpochChangeLedgerInfosResponse)) {
    throw new Error('Expected argument of type storage.GetEpochChangeLedgerInfosResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_storage_GetEpochChangeLedgerInfosResponse(buffer_arg) {
  return storage_pb.GetEpochChangeLedgerInfosResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var StorageService = exports.StorageService = {
  ...
  getEpochChangeLedgerInfos: {
    path: '/storage.Storage/GetEpochChangeLedgerInfos',
    requestStream: false,
    responseStream: false,
    requestType: storage_pb.GetEpochChangeLedgerInfosRequest,
    responseType: storage_pb.GetEpochChangeLedgerInfosResponse,
    requestSerialize: serialize_storage_GetEpochChangeLedgerInfosRequest,
    requestDeserialize: deserialize_storage_GetEpochChangeLedgerInfosRequest,
    responseSerialize: serialize_storage_GetEpochChangeLedgerInfosResponse,
    responseDeserialize: deserialize_storage_GetEpochChangeLedgerInfosResponse,
  },
};
